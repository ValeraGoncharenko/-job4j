...
public class BankServiceTest {
    ...
    public void whenEnterInvalidPassport() {
        ...
        assertThat(bank.findByRequisite("35", "5546"), is (Optional.empty()));
    }
    ...
    @Test
    public void noTransferMoney() {
        User user = new User("3434", "Petr Arsentev");
        BankService bank = new BankService();
        bank.addUser(user);
        bank.addAccount(user.getPassport(), new Account("5546", 0D));
        bank.addAccount(user.getPassport(), new Account("113", 50D));
    ...
    public void yesTransferMoney() {
        ...
        bank.addAccount(user.getPassport(), new Account("5546", 150D));
        bank.addAccount(user.getPassport(), new Account("113", 50D));
        assertThat(bank.transferMoney(user.getPassport(), "5546", user.getPassport(), "113", 150D), is(true));
    }
}